...
const isCurrentMonth = (month) => {
    const propsDate = new Date(props.modelValue.year, props.modelValue.month, props.modelValue.date)
...
watch(() => props.modelValue, (newValue) => {
    if (newValue) {
        currentDate.value = new Date(newValue.year, newValue.month, newValue.date)
    }
}, { immediate: true })
